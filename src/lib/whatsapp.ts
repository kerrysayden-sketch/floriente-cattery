...
const MESSAGES: Record<WhatsAppIntent, Record<Lang, string>> = {
  nextLitter: {
    en: 'Hello! I would like to ask about the next Oriental or Siamese litter, expected around mid-July 2026, and join the waiting list.',
    ru: 'Здравствуйте! Хочу узнать о следующем помёте ориентальных или сиамских котят, который ожидается ориентировочно в середине июля 2026, и попасть в лист ожидания.',
    uk: 'Вітаю! Хочу дізнатися про наступний помет орієнтальних або сіамських кошенят, який очікується орієнтовно в середині липня 2026, і потрапити до списку очікування.',
    de: 'Hallo! Ich möchte nach dem nächsten Oriental- oder Siam-Wurf fragen, der voraussichtlich Mitte Juli 2026 erwartet wird, und mich auf die Warteliste setzen lassen.',
    pl: 'Dzień dobry! Chciałbym zapytać o kolejny miot kotów orientalnych lub syjamskich, spodziewany około połowy lipca 2026, i dołączyć do listy oczekujących.',
  },
  generalContact: {
